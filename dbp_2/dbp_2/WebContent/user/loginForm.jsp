								...
								<form name="form" action="<c:url value='/user/login' />"
									...
									<div class="form-group">
										<div style="margin-bottom: 10%; width: 200%;">
											<input type=radio name="position" value="n1" checked="checked">손님
											&nbsp;&nbsp;<input type=radio name="position" value="n2">사장님
										</div>
									</div>
									<div class="form-group">
										<input type="text" name="userId" class="form-control"
											id="userId" placeholder="ID" data-rule="minlen:4"
									...
									<div class="form-group">
										<input type="password" class="form-control" name="password"
											id="password" placeholder="PW" data-rule="minlen:4"
											data-msg="Please enter at least 4 chars"
											style="width: 180px;" />
										<div class="validate"></div>
									</div>
