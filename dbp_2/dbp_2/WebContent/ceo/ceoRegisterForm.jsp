...
#name, #phone, #ceoId, #password, #ceoNum {
	width: 280px;
	height: 30px;
}
...
<script>
	function userCreate() {
		...
		if(emailExp.test(form.ceoId.value)==false) {
	...
	<main id="main">
		<div class="container">
			<section id="why-us" class="why-us">
				<form name="form" action="<c:url value='/ceo/register' />" method="POST">
					<!-- 고객정보 -->
					<div class="customer_info" style="text-align: center;">
						...
						<div class="customer_info_contents">
							<table id="tb_customer_info_register">
								<tr>
									<td class="register_email">Email(Id)</td>
									<td><input type="text" id="ceoId" name="ceoId"
										<c:if test="${registerFailed}">value="${user.ceoId}"</c:if>></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="register_ceoNum">사업자 등록번호</td>
									<td><input type="text" id="ceoNum" name="ceoNum" /></td>
								</tr>
								<tr>
